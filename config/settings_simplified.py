"""
إعدادات Django المبسطة لخدمة المصادقة
"""
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default=f'postgresql://postgres:password@localhost:5432/{config("DATABASE_NAME", default="naibak_auth_db")}')
    )
}
